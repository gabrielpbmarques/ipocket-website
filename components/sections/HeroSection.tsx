      ...
      <Container className="grid items-center gap-10 sm:grid-cols-2">
        <AnimateInView>
          <div>
            ...
            <p className="mt-4 text-lg subtle">
              Inspirado na tendência global do iPhone Pocket (Pocket iPhone Bag), agora em uma versão feita no Brasil, com preço nacional.
            </p>
        ...
        <AnimateInView delay={0.05}>
          <div className="relative mx-auto aspect-[4/5] w-full max-w-md overflow-hidden rounded-[var(--radius-lg)] bg-[var(--color-surface)] muted-border">
            <Image
              src="/mock-hero.png"
              alt="iPocket Brasil - Estilo Pocket iPhone"
              fill
              priority
